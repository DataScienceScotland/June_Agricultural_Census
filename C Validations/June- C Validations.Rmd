...
## Error 1
The following table displays errors for holdings where total area is not equal to area rented (item20226 (2023 onwards) item7 (up to 2021))  + area owned (item 11) 
...
## Error 2
The following table displays possible errors for holdings where total seasonal rent (item2) doesn't match with area rented( item7, section 1)

```{r, June - C-Validations-err2, results = 'markup'} 
  ifelse(nrow(err2) ==0, "No errors found", "Errors found - item2 != item7")
kable(err2, caption = "Total seasonal rents doesn't match area rented (item2 != item7)")

```

## Error 3
The following table displays possible errors for holdings where seasonal let items (item2827, item2828) are not equal to seasonal lets total (item2)
...
## Error 5 - Crops
The following table displays possible errors for holdings where total area of crops and grassland (item46), rough grazing (item47), woodland (item48) and other land (item49) is not equal to total land (item50) 
...
The following table displays possible errors for holdings where total veg (SAF, item86) is not equal to total veg (census, item35 / item 27730 (2023))
...
The following table displays possible errors for holdings where soft fruit area (item37) is not equal to all fruit (SAF, item76)
...
<!-- The following table displays possible errors for holdings where flowers, bulbs and nursery stock (items 80:83, item1709:1710, item2324) are not equal to total (item84/ item27740 (2023)) -->
...
The following table displays possible errors for holdings where the area of glasshouse crops is larger than the area of glasshouses (open soil or solid floor)
...
The following table displays possible errors for holdings where glasshouses are indicated but items are not specified
...
# Section 4 Pigs
## Error 13
The following table displays possible errors for holdings where pig items (item146-156) are not equal to total pigs (item157)
...
# Section 5 Sheep
## Error 15
The following table displays possible errors for holdings where sheep items (items 139-141, 143-144) are not equal to total sheep (item145)
...
# Section 6 Poultry
## Error 17
The following table displays possible errors for holdings where poultry items (item158-164, item167, item1708, item2038-2039) are not equal to total poultry (item170)
...
<!-- ##Error29 -->
<!-- The following table displays possible errors for holdings where the legal responsbility box is ticked (item2980) but no details for occupier1/2 are given -->
<!-- ```{r, June - C-Validations-err29, results = 'markup'}  -->
<!-- ifelse(nrow(err29) ==0,  "No errors found", "Errors found") -->
<!-- kable(err29, caption = "Legal responsbility box is ticked (item2980) but no details for occupier1/2 are given" ) -->
<!-- ``` -->
...
## Error 32
The following table displays possible errors for holdings where total labour (item200) is not equal to sum of labour items 
...
ifelse(nrow(err42) ==0,  "No errors found", "Errors found- che- check for punch errors or misunderstanding of requirement of people/days in labour questions")
...
The following table displays the count of validation errors. The total cases with errors is given on the final row.
