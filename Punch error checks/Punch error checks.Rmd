...
source("./punch-error-checks_files/item categories.R",  local = knitr::knit_global())
...
knitr::read_chunk("./punch-error-checks_files/punch error tables.R")
```
```{r, punch error tables-perr1, results = 'asis'}
...
```{r, punch error tables-perr2, results = 'asis'} 
...
```{r, punch error tables-perr3, results = 'asis'} 
...
<!-- ```{r, punch error tables-perr4, results = 'asis'}  -->
...
<!-- ```{r, punch error tables-perr5, results = 'asis'}  -->
...
<!-- ```{r, punch error tables-perr6, results = 'asis'}  -->
...
```{r, punch error tables-perr7, results = 'asis'} 
...
```{r, punch error tables-perr9, results = 'asis'} 
...
```{r, punch error tables-perr 10, results = 'asis'} 
...
<!-- ```{r, punch error tables-perr11, results = 'asis'}  -->
<!-- perr11 <- perr11 %>% filter(error == "Error") %>%  -->
<!--   rename(yr = male, yr1 = omale, yr2 =vomale) -->
<!-- ifelse(nrow(perr10) ==0,  "No errors found", "Errors found") -->
<!-- kable(perr11, caption = "Potential ntroduction of male cattle to holding with only female cattle (excluding bulls for service)" ) -->
...
<!-- ```{r, punch error tables-perr12, results = 'asis'}  -->
...
```{r, punch error tables-perr13, results = 'asis'} 
...
```{r, punch error tables-perr14, results = 'asis'} 
...
```{r, punch error tables-perr15, results = 'asis'} 
...
```{r, punch error tables-perr16, results = 'asis'} 
...
<!-- ```{r, punch error tables-perr17, results = 'asis'}  -->
