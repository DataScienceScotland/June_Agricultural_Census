...
# SAF commented out as the first SAF data is already imported. Comment back in when we get a new SAF data cut (September?)
...
# 
# df_scheme <- read.xlsx(paste0(SAF_directory, "/scheme_output1.xlsx"),sep.names = "_") # called script2 in SAS
...
# Check missing values are set to zero. Code this in if necessary
...
# 
# 
# save(df_crofts, file = paste0(Code_directory, "/crofts_A.rda"))
