...
saf_perm_final <- parishholdingslc(saf_perm_final)
...
saf_perm$area <- as.numeric(saf_perm$area)
...
# Check frequency of fids - multiple holdings using the same fid.
